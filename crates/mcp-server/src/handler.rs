...
//!
//! ```ignore
//! use mcp_server::{ServerHandler, ToolHandler, ServerInfo};
//!
//! struct MyServer;
//!
...
//!     async fn list_tools(&self, ctx: &Context) -> Result<Vec<Tool>, McpError> {
//!         Ok(vec![...])
//!     }
//!
//!     async fn call_tool(&self, name: &str, args: Value, ctx: &Context) -> Result<ToolOutput, McpError> {
//!         // Handle tool calls
//!     }
//! }
//! ```
...
///
/// ```ignore
/// use mcp_server::{SamplingHandler, Context};
/// use mcp_core::types::sampling::{CreateMessageRequest, CreateMessageResult};
/// use mcp_core::error::McpError;
///
/// struct MyServer;
///
...
///
/// ```ignore
/// use mcp_server::{ElicitationHandler, Context};
/// use mcp_core::types::elicitation::{ElicitRequest, ElicitResult};
/// use mcp_core::error::McpError;
///
/// struct MyServer;
///
