...
use mcp_core::types::elicitation::{
...
impl ElicitationRequestBuilder {
    ...
    pub fn text_response(self, field_name: impl Into<String>) -> Self {
        self.schema(
            ElicitationSchema::object()
                .property(field_name, mcp_core::types::elicitation::PropertySchema::string()),
        )
    }
    ...
    pub fn boolean_response(self, field_name: impl Into<String>) -> Self {
        self.schema(
            ElicitationSchema::object()
                .property(field_name, mcp_core::types::elicitation::PropertySchema::boolean()),
        )
    }
