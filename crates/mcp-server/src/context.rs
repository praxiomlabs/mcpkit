...
//!
//! ```ignore
//! async fn my_tool_handler(&self, ctx: &Context<'_>) -> Result<ToolOutput, McpError> {
...
//!
//!     // Report progress
//!     ctx.progress(50, Some(100), Some("Halfway done")).await?;
//!
...
use mcp_core::protocol::{Notification, ProgressToken, RequestId};
