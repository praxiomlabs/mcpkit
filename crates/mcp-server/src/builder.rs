...
//!
//! ```ignore
//! use mcp_server::{ServerBuilder, Server};
//!
//! let server = ServerBuilder::new(MyHandler)
//!     .with_tools(MyToolHandler)
//!     .with_resources(MyResourceHandler)
//!     .build();
//!
...
//!
//! ```ignore
//! // This compiles - tools are registered
//! let server = ServerBuilder::new(handler)
//!     .with_tools(tool_handler)
//!     .build();
//!
//! // This would be a compile error - can't register tools twice
//! // let server = ServerBuilder::new(handler)
//! //     .with_tools(tool_handler)
//! //     .with_tools(another_tool_handler)  // ERROR!
//! //     .build();
//! ```
    ...
    H: ServerHandler,
{
    ...
    #[must_use]
    pub fn server_info(&self) -> mcp_core::capability::ServerInfo {
...
mod tests {
    use super::*;
    use mcp_core::capability::ServerInfo;
