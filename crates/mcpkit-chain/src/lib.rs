...
//!
//! `mcpkit-chain` provides a set of composable building blocks for creating
//! LLM pipelines. Inspired by [LangChain Expression Language (LCEL)](https://python.langchain.com/docs/concepts/lcel/),
//! it enables declarative composition of LLM operations.
//!
//! # Core Concepts
//!
...
//! ```rust,ignore
//! use mcpkit_chain::{
//!     Runnable, ChainValue, RunnableSequence, RunnableParallel,
//!     PromptRunnable, LlmRunnable,
//! };
...
pub use llm::{JsonParseRunnable, LlmRunnable, PromptRunnable};
pub use runnable::{ChainValue, Runnable, RunnableParallel, RunnableSequence};
pub use runnables::{
    BoxedRunnable, RunnableAssign, RunnableBranch, RunnableConst, RunnableFn, RunnablePassthrough,
    RunnablePick, RunnableRetry,
};
