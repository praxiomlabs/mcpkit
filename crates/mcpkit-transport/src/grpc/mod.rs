...
#[doc(hidden)]
// Generated by tonic-build from proto/mcp.proto and checked in. Lints are
// allowed at the module declaration rather than inside the file, because
// `just generate-proto` overwrites it wholesale and the proto-check job fails
// on any drift — an edit inside would be reverted on the next regeneration.
