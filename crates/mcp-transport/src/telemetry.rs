...
//!
//! # Usage with tracing-opentelemetry
//!
//! The simplest integration is via the `tracing` ecosystem:
//!
//! ```ignore
//! use mcp_transport::telemetry::{TelemetryConfig, TelemetryLayer};
//! use tracing_subscriber::prelude::*;
//!
//! // Configure OpenTelemetry via tracing subscriber
...
//!     .init();
//!
//! // Wrap transport with telemetry layer
//! let transport = TelemetryLayer::new(config)
//!     .layer(transport);
//! ```
//!
//! # Span Attributes
